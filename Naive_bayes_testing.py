...
def Classify(X1, X2):
    ...
    p = q[0] # p contains p(Decision)=?
    arr1 = q[1] # arr1 contains p(X={high/low}|Decision={yes/no}) or p(Y={high/low}|Decision={yes/no})
    attributes = q[2] # attributes contain X, Y
    target_attribute_value = q[3] # target_attribute_value contain yes, no
